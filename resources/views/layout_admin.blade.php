        ...
        <header id="header" class="dark submenu-light">
            <div class="header-inner">
                <div class="container">
                    ...
                    <div id="logo">
                        <a href="{{ url('/dasboard') }}">
                            <span class="logo-default logo-owner">PERAN ADMIN</span>
                            <span class="logo-dark logo-owner">PERAN ADMIN</span>
                        </a>
                    </div>
                    <!--End: Logo-->
                        ...
                        <div class="container">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="{{ url('/hasil_aduan') }}">Hasil Pengaduan</a></li>
                                    <li><a href="{{ url('/saran/table') }}">Buat Saran</a></li>
                                    <li>
                                        <a href="{{ route('logout') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row" style="justify-content: end;">
                                ...
                                <div class="col-lg-3">
                                    <div class="widget">
                                        <div class="widget-title">Halaman Admin</div>
                                        <ul class="list">
                                            <li><a href="{{ url('hasil_aduan') }}">Hasil Pengajuan</a></li>
                                            <li><a href="{{ url('saran/table') }}">Buat Saran</a></li>
                                        </ul>
                                    </div>
                                </div>
